...
public:
    ...
    void setupUi(QDialog *AddBook)
    {
        ...
        AddBook->resize(1315, 780);
        frame = new QFrame(AddBook);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setGeometry(QRect(50, 10, 1021, 691));
...
"color: white;"));
        ...
        splitter->setGeometry(QRect(520, 630, 150, 23));
